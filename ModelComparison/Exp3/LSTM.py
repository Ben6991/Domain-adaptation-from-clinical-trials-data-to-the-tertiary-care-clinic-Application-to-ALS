...
new_preds_path = folder + f'Exp3/TAMC_{model_name}/predictions/'
MODEL_PATH = folder + f'Exp3/{model_name}/models/{number_iter}.model'
TAMC = pd.read_csv(folder + 'TAMC2.csv')
train_test_file = folder + 'TAMC_2_train_test_split.pkl'
initial_model = folder + f'Exp3/{model_name}/initial_model.model'
...
X_test, y_test, lengths_test = ts.create_temporal_Xy_lists(preprocessed_data, features, test_dict, True, 1, True, t_pred=True, time_to_next=True)
